...
function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <button
              ...
              className="text-gray-300 hover:text-green-400 transition-all relative group"
            >
              Features
          ...
          <button className="bg-gradient-to-r from-green-500 to-emerald-500 px-6 py-2 rounded-full font-semibold text-black hover:from-green-400 hover:to-emerald-400 transition-all shadow-lg hover:shadow-green-500/50 hover:scale-105">
            Get Started
          </button>
        </div>
      </nav>
      ...
      <section className="min-h-screen flex items-center justify-center px-6 relative">
        ...
        <div className="text-center space-y-8 max-w-4xl mx-auto relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
            <button className="bg-gradient-to-r from-green-500 to-emerald-500 px-8 py-4 rounded-full font-bold text-lg text-black hover:from-green-400 hover:to-emerald-400 transition-all shadow-2xl hover:shadow-green-500/50 hover:scale-105 group">
              Try Demo
              <ArrowRight className="inline-block ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </button>
            <button className="border-2 border-green-500/50 px-8 py-4 rounded-full font-bold text-lg text-green-400 hover:border-green-400 hover:bg-green-500/10 transition-all hover:scale-105">
              Learn More
            </button>
          </div>
        </div>
      ...
      <section id="features" className="py-20 px-6 relative">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Soil Insights */}
            <div className="group bg-gradient-to-br from-green-900/20 to-emerald-900/20 backdrop-blur-lg border border-green-500/30 rounded-2xl p-8 hover:border-green-400/60 transition-all hover:scale-105 hover:shadow-2xl hover:shadow-green-500/20">
              ...
              <p className="text-gray-300">
                Analysis of soil pH, nutrients, and moisture levels with
                real-time monitoring and predictive analytics for optimal crop
                conditions.
              </p>
            </div>
            ...
            <a
              ...
              className="block"
            >
              <div className="group bg-gradient-to-br from-teal-900/20 to-cyan-900/20 backdrop-blur-lg border border-teal-500/30 rounded-2xl p-8 hover:border-teal-400/60 transition-all hover:scale-105 hover:shadow-2xl hover:shadow-teal-500/20">
                ...
                <p className="text-gray-300">
                  Real-time and long-term climate predictions using advanced
                  meteorological data and machine learning algorithms.
                </p>
              </div>
            </a>
            ...
            <a
              ...
              className="block"
            >
              <div className="group bg-gradient-to-br from-emerald-900/20 to-green-900/20 backdrop-blur-lg border border-emerald-500/30 rounded-2xl p-8 hover:border-emerald-400/60 transition-all hover:scale-105 hover:shadow-2xl hover:shadow-emerald-500/20">
                ...
                <p className="text-gray-300">
                  Machine learning models for accurate yield forecasts using
                  historical data, current conditions, and predictive analytics.
                </p>
              </div>
            </a>
          </div>
      ...
      <section id="about" className="py-20 px-6 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-12">
            AgriAI leverages artificial intelligence to empower farmers with
            data-driven decisions, driving sustainable agriculture and improved
            yields. Our platform combines cutting-edge ML with real-world
            expertise to revolutionize farming.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16">
            ...
            <div>
              <div className="bg-gradient-to-br from-teal-500/20 to-cyan-500/20 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <div>
              <div className="bg-gradient-to-br from-emerald-500/20 to-green-500/20 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <footer
        id="contact"
        className="border-t border-green-500/20 bg-black/40 backdrop-blur-sm py-12 px-6"
      >
