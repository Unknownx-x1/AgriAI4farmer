    ...
    <div className="min-h-screen bg-black text-white relative overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full z-50 bg-black/20 backdrop-blur-md border-b border-green-500/20">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <button
            onClick={() => (window.location.href="https://chatbot12-omega.vercel.app/", "")}
      ...
      <section className="min-h-screen flex items-center justify-center px-6 relative">
        ...
        <div className="text-center space-y-8 max-w-4xl mx-auto relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
            ...
            <a
              href="https://www.mediafire.com/file/dww0fbvkmwn3t9z/AgriAI.apk/file" // 🔗 Replace this with your app download link
              target="_blank"
              rel="noopener noreferrer"
              className="bg-gradient-to-r from-green-500 to-emerald-500 px-8 py-4 rounded-full font-bold text-lg text-black hover:from-green-400 hover:to-emerald-400 transition-all duration-300 shadow-2xl hover:shadow-green-500/50 hover:scale-105 group"
            >
              Download Our App
      ...
      <section id="features" className="py-20 px-6 relative z-40">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Marketplace */}
            <a href="https://damazon.onrender.com" className="block relative z-50">
            ...
            {/* AI Predictions */}
            <a href="https://huggingface.co/spaces/illegalmonkey/agri-ai-iot" className="block relative z-50">
